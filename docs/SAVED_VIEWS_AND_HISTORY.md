...
Im Hauptfenster kann der komplette lokale Verlauf über **Verlauf löschen** entfernt werden.
...
Der Verlauf ändert sich dagegen bei jeder Verbindung und wird deshalb separat gehalten. So lässt er sich löschen oder später durch einen anderen History-/Audit-Provider ersetzen, ohne die eigentliche Zielkonfiguration zu verändern.
